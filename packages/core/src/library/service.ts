              ...
              Effect.mapError(
                (cause) =>
                  new LibraryServiceError({
                    message: "Unable to load linked providers.",
                    cause,
                  })
              )
            )
        ...
        return yield* database
          ...
          .pipe(
            Effect.mapError(
              (cause) =>
                new LibraryServiceError({
                  message: "Unable to queue library sync.",
                  cause,
                })
            )
          )
        ...
        const rows = yield* database
          ...
          .pipe(
            Effect.mapError(
              (cause) =>
                new LibraryServiceError({
                  message: "Unable to load library entry.",
                  cause,
                })
            )
          )
            ...
            database
              ...
              .pipe(
                Effect.mapError(
                  (cause) =>
                    new LibraryServiceError({
                      message: "Unable to count library entries.",
                      cause,
                    })
                )
              ),
        ...
        yield* database
          ...
          .pipe(
            Effect.mapError(
              (cause) =>
                new LibraryServiceError({
                  message: "Unable to save library entry.",
                  cause,
                })
            )
          )
        ...
        yield* database
          ...
          .pipe(
            Effect.mapError(
              (cause) =>
                new LibraryServiceError({
                  message: "Unable to remove library entry.",
                  cause,
                })
            )
          )
            ...
            database
              ...
              .pipe(
                Effect.mapError(
                  (cause) =>
                    new LibraryServiceError({
                      message: "Unable to load sync activity.",
                      cause,
                    })
                )
              ),
            database
              ...
              .pipe(
                Effect.mapError(
                  (cause) =>
                    new LibraryServiceError({
                      message: "Unable to count sync activity.",
                      cause,
                    })
                )
              ),
          ...
          const events = yield* database
            ...
            .pipe(
              Effect.mapError(
                (cause) =>
                  new LibraryServiceError({
                    message: "Unable to load failed sync events.",
                    cause,
                  })
              )
            )
